...
* https://github.com/Tendrl/documentation/blob/master/frontend/README.adoc[Tendrl
  Frontend Overview] details the frontend stack, build, package, deployment etc.
